...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute right-0 lg:-right-20 top-1/2 -translate-y-1/2 w-[480px] h-[480px] lg:w-[800px] lg:h-[800px] opacity-40 pointer-events-none">
        <AnimatedSphere />
      </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          <h1
            className={`text-[clamp(2.5rem,10vw,6rem)] font-display leading-[0.9] tracking-tight transition-all duration-1000 ${
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "50+", label: "campaigns delivered", org: "ACROSS AFRICA" },
                { value: "25+", label: "countries engaged", org: "PAN-AFRICAN" },
                { value: "100+", label: "partner organizations", org: "ECOSYSTEM" },
                { value: "8+", label: "years of impact", org: "BEACONFOLD" },
              ].map((stat) => (
