...
export function ServicePageContent({ service }: { service: Service }) {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden noise-overlay">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-end overflow-hidden bg-foreground">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 pb-16 lg:pb-24 pt-40">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl max-w-2xl leading-relaxed" style={{ color: "var(--gold)" }}>
              {service.tagline}
            </p>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 border-t border-foreground/10">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-5xl font-display tracking-tight">Core offerings.</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-px bg-foreground/10">
            {service.offerings.map((offering, i) => (
              ...
              >
                <div className="w-8 h-px mb-6" style={{ backgroundColor: "var(--gold)" }} />
      ...
      {/* ── Our Approach ─────────────────────────────────────── */}
      <section className="relative py-20 lg:py-28 bg-foreground overflow-hidden">
        <div
